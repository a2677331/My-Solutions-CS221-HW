...
; H(n - 1, s, 6 - s - f);
    push    dx       ; pass n - 1 as Value parameter
    push    [bp+22]  ; pass s as Value parameter
    push    ax       ; pass 6 - s - f as Value parameter
...
; H(n - 1, 6 - s - f, f);
    push    dx          ; pass n - 1 as Value parameter
    push    ax          ; pass 6 - s - f as Value parameter
    push    [bp+20]     ; pass f as Value parameter
    call    H           ; call H procedure recursively
ENDIF01: nop
